...
<body onload="window.print();">
   ...
   <?php 
     ...
     $ambil1 = $koneksi->query("SELECT * FROM audiometri JOIN pegawai_perusahaan ON audiometri.id_pegawai = pegawai_perusahaan.id_pegawai JOIN perusahaan ON audiometri.id_perusahaan = perusahaan.id_perusahaan WHERE mulai_uji = '$mulai_uji'");
   ...
   <table border="1" cellpadding="4" cellspacing="0" width="100%">
		...
		<tbody>
		<?php $nomor = 1; ?>
		<?php $ambil2 = $koneksi->query("SELECT * FROM audiometri JOIN perusahaan ON audiometri.id_perusahaan = perusahaan.id_perusahaan JOIN pegawai_perusahaan ON audiometri.id_pegawai = pegawai_perusahaan.id_pegawai WHERE mulai_uji = '$mulai_uji'"); ?>
        ...
        <td><?php echo $pecah2['telinga_kanan_nol'] ?></td>
        <td><?php echo $pecah2['telinga_kanan_satu'] ?></td>
        <td><?php echo $pecah2['telinga_kanan_dua'] ?></td>
        <td><?php echo $pecah2['telinga_kanan_tiga'] ?></td>
        <td><?php echo $pecah2['telinga_kanan_empat'] ?></td>
        <td><?php echo $pecah2['telinga_kanan_enam'] ?></td>
        <td><?php echo $pecah2['telinga_kanan_delapan'] ?></td>
        <td><?php echo $pecah2['telinga_kiri_nol'] ?></td>
        <td><?php echo $pecah2['telinga_kiri_satu'] ?></td>
        <td><?php echo $pecah2['telinga_kiri_dua'] ?></td>
        <td><?php echo $pecah2['telinga_kiri_tiga'] ?></td>
        <td><?php echo $pecah2['telinga_kiri_empat'] ?></td>
        <td><?php echo $pecah2['telinga_kiri_enam'] ?></td>
        <td><?php echo $pecah2['telinga_kiri_delapan'] ?></td>
  ...
  <?php $nomor = 1; ?>
    <?php $ambil3 = $koneksi->query("SELECT * FROM audiometri 
