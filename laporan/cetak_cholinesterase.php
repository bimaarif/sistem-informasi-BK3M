...
<body onload="window.print()">
   ...
   <?php 
     ...
     $ambil1 = $koneksi->query("SELECT * FROM cholinesterase JOIN pegawai_perusahaan ON cholinesterase.id_pegawai = pegawai_perusahaan.id_pegawai JOIN perusahaan ON cholinesterase.id_perusahaan=perusahaan.id_perusahaan WHERE mulai_uji = '$mulai_uji'");
   ...
   <table border="1" cellpadding="4" cellspacing="0" width="100%">
    ...
    <tbody>
    <?php $nomor = 1; ?>
    <?php $ambil2 = $koneksi->query("SELECT * FROM cholinesterase JOIN perusahaan ON cholinesterase.id_perusahaan = perusahaan.id_perusahaan JOIN pegawai_perusahaan ON cholinesterase.id_pegawai = pegawai_perusahaan.id_pegawai WHERE mulai_uji = '$mulai_uji'"); ?>
    <?php while($pecah2 = $ambil2->fetch_assoc()){ ?>
      <tr>
        ...
        <td><?php echo $pecah2['hasil'] ?></td>
        <td><?php echo $pecah2['penilaian'] ?></td>
        <td><?php echo $pecah2['keterangan'] ?></td>
      </tr>
    <?php $nomor++; ?>
    <?php } ?>  
    </tbody>
  ...
  <?php $nomor = 1; ?>
    <?php $ambil3 = $koneksi->query("SELECT * FROM cholinesterase 
