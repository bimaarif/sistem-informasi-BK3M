...
<body onload="window.print()">
   ...
   <center><h4>BALAI KESELAMATAN DAN KESEHATAN KERJA MEDAN</h4></center>
   <hr>
   <center><h4>Hasil analisis</h2></center>
   <?php 
     $mulai_uji = $_GET['mulai_uji'];
     $ambil1 = $koneksi->query("SELECT * FROM pb_dalam_darah 
   ...
   <table border="1" cellpadding="4" cellspacing="0" width="100%">
		...
		<tbody>
		<?php $nomor = 1; ?>
		<?php $ambil2 = $koneksi->query("SELECT * FROM pb_dalam_darah JOIN perusahaan ON pb_dalam_darah.id_perusahaan = perusahaan.id_perusahaan JOIN pegawai_perusahaan ON pb_dalam_darah.id_pegawai = pegawai_perusahaan.id_pegawai WHERE mulai_uji = '$mulai_uji'"); ?>
  ...
  <?php $nomor = 1; ?>
    <?php $ambil3 = $koneksi->query("SELECT * FROM pb_dalam_darah 
     JOIN perusahaan ON pb_dalam_darah.id_perusahaan = perusahaan.id_perusahaan 
     JOIN pegawai_perusahaan ON pb_dalam_darah.id_pegawai = pegawai_perusahaan.id_pegawai
