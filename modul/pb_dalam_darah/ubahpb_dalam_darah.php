...
<?php 
 ...
 $ambil = $koneksi->query("SELECT * FROM pb_dalam_darah WHERE id_pb_dalam_darah='$_GET[id_pb_dalam_darah]'");
...
<div class="panel panel-primary">
    <div class="panel-heading">
       <strong>Ubah Data Pb Dalam Darah</strong>  
    </div>
...
<form  method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <?php 
             $ambil2 = $koneksi->query("SELECT * FROM pegawai_perusahaan JOIN pb_dalam_darah ON pegawai_perusahaan.id_pegawai = pb_dalam_darah.id_pegawai WHERE id_pb_dalam_darah='$_GET[id_pb_dalam_darah]'"); 
...
if (isset($_POST['ubah'])) {
   $koneksi->query("UPDATE pb_dalam_darah SET 
                   ...
                   WHERE id_pb_dalam_darah='$_GET[id_pb_dalam_darah]'");
